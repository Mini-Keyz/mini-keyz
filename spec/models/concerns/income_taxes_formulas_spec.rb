...
RSpec.describe IncomeTaxesFormulas do
  ...
  describe '#calc_fiscal_nb_parts_for_dependent_children' do
    it "returns the number of fiscal parts generated by household's dependent children" do
      result_lyon = simulation_lyon.calc_fiscal_nb_parts_for_dependent_children
      result_bordeaux = simulation_bordeaux.calc_fiscal_nb_parts_for_dependent_children
  ...
  describe '#calc_fiscal_nb_parts_for_alternate_custody_children' do
    it "returns the number of fiscal parts generated by household's alternate custody children" do
      result_lyon = simulation_lyon.calc_fiscal_nb_parts_for_alternate_custody_children
      result_bordeaux = simulation_bordeaux.calc_fiscal_nb_parts_for_alternate_custody_children
